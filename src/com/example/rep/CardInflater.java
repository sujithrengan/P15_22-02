...
import com.example.rep.BaseInflaterAdapter;
import com.example.rep.CardItemData;
import com.example.rep.IAdapterViewInflater;
...
public class CardInflater implements IAdapterViewInflater<CardItemData>
{
	...
	private class ViewHolder
	{
		...
		public void updateDisplay(CardItemData item)
		{
			...
			Typeface custom_font = Typeface.createFromAsset(m_text1.getContext().getAssets(),
			        "fonts/Roboto-Light.ttf");
			m_text1.setTypeface(custom_font);
		}
	}
}
